...
//4. La tabla fue creada hardcoded, sin embargo estamos acostumbrados a crear la tabla directamente desde storyboards y llenarla de forma similar como se hace en el ejemplo. Pero configurando mejor su diseño y llenado de datos desde un UITableViewCell cuyo delegado sería el ViewController.
